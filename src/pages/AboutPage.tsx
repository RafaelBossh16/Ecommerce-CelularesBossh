  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-4 tracking-tighter leading-7 text-sm font-medium text-slate-800">
        <p>
          CelularesBossh es una tienda en línea que se dedica a la venta de
          celulares, fundada en 2005. Nuestro objetivo es ofrecer a nuestros
        ...
        <p>
          En CelularesBossh podrás encontrar una amplia variedad de celulares de
        ...
        <h2 className="text-3xl font-semibold tracking-tight mt-8 mb-4">
          ¡No esperes más y compra tu celular en CelularesBossh!
        </h2>

        <p>
          Para más información, no dudes en ponerte en contacto con nosotros, a
          través de nuestro correo electrónico: <a href="mailto:rafaelhuamanitejeda2005@gmail.com">
            rafaelhuamanitejeda2005@gmail.com
          </a>{" "}
          o llamado al <a href="tel:904801897">904801897</a>
        </p>
      </div>
    </div>
  );
